...
public class Ex7_Carlos {
    ...
    public static void main(String[] args) {
        ...
        int pessoas = 2, idade[] = new int[pessoas], mediaPessoa[] = new int[3];
        double peso[] = new double[pessoas], altura[] = new double[pessoas], mediaAltura = 0;
        ...
        mediaPessoa[2] = (mediaPessoa[2] / 100);
